...
module mqc_czt_mp2
   ...
   public :: run_czt_mp2
   public :: run_czt_ri_mp2
   public :: run_czt_ump2
   public :: run_czt_uri_mp2
   public :: mp2_result_t
...
contains
   ...
   subroutine run_czt_mp2(mol, coeff, orbital_energies, n_occ, scf_energy, &
   ...
   end subroutine run_czt_mp2

   subroutine run_czt_ri_mp2(mol, aux, coeff, orbital_energies, n_occ, scf_energy, &
   ...
   !
   subroutine run_czt_ump2(mol, coeff_a, coeff_b, eps_a, eps_b, &
      ...
      call fill_ump2_result(result, e_aa + e_bb, e_ab, scf_energy, frozen, &
                            n_oa + n_ob, n_va + n_vb)
   end subroutine run_czt_ump2

   subroutine run_czt_uri_mp2(mol, aux, coeff_a, coeff_b, eps_a, eps_b, &
                              n_occ_a, n_occ_b, scf_energy, result, error, n_frozen)
      ...
      call fill_ump2_result(result, e_aa + e_bb, e_ab, scf_energy, frozen, &
                            n_oa + n_ob, n_va + n_vb)
   end subroutine run_czt_uri_mp2
   ...
   function ri_like_spin_energy(bia, eps, frozen, n_occ, n_o, n_v) result(e)
      ...
      ! TODO(mqc): serial, where `run_czt_ri_mp2` threads the identical
