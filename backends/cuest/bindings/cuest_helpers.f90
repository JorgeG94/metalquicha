...
contains
   ...
   function cuest_status_name(st) result(name)
      ...
      case (CUEST_STATUS_SUCCESS)
         name = "CUEST_STATUS_SUCCESS"
      case (CUEST_STATUS_EXCEPTION)
         name = "CUEST_STATUS_EXCEPTION"
      case (CUEST_STATUS_NULL_POINTER)
         name = "CUEST_STATUS_NULL_POINTER"
      case (CUEST_STATUS_INVALID_ARGUMENT)
         name = "CUEST_STATUS_INVALID_ARGUMENT"
      case (CUEST_STATUS_INVALID_SIZE)
         name = "CUEST_STATUS_INVALID_SIZE"
      case (CUEST_STATUS_INVALID_TYPE)
         name = "CUEST_STATUS_INVALID_TYPE"
      case (CUEST_STATUS_INVALID_PARAMETER)
         name = "CUEST_STATUS_INVALID_PARAMETER"
      case (CUEST_STATUS_INVALID_ATTRIBUTE)
         name = "CUEST_STATUS_INVALID_ATTRIBUTE"
      case (CUEST_STATUS_INVALID_HANDLE)
         name = "CUEST_STATUS_INVALID_HANDLE"
      case (CUEST_STATUS_UNKNOWN_ERROR)
         name = "CUEST_STATUS_UNKNOWN_ERROR"
      case (CUEST_STATUS_UNSUPPORTED_ARGUMENT)
         name = "CUEST_STATUS_UNSUPPORTED_ARGUMENT"
      case (CUEST_STATUS_UNSUPPORTED_ARCHITECTURE)
         name = "CUEST_STATUS_UNSUPPORTED_ARCHITECTURE"
      case (CUEST_STATUS_INVALID_PLAN)
         name = "CUEST_STATUS_INVALID_PLAN"
      case (CUEST_STATUS_HOME_NOT_FOUND)
         name = "CUEST_STATUS_HOME_NOT_FOUND"
      case default
         name = "<unknown>"
      end select
