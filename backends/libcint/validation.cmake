...
# -DMQC_ENABLE_LIBCINT=OFF should not mention these targets at all, and the way
# to guarantee that is to define them in the directory that only exists when the
# backend does.
#
# Included from backends/libcint/CMakeLists.txt, which the dependency resolution
# add_subdirectory()s once it has settled which of libfint and libcint is
# providing the integrals. `${MQC_INTEGRALS_LIBS}` therefore already names the
# right one, and nothing here has to know which.
