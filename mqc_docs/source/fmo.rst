...
GAMESS FMO2, its default field     +3.9e-4      +6.4e-4
=================================  ===========  ===========
...
ER brings GAMESS's row closer to the molecule and moves the point-charge row
further from it.
...
it does by default, the tripeptide's ER monomers move another 2e-7. GAMESS's own FMO2 total
needs its exact field, which a detached bond is refused with here.

With a field, FMO2 on the same
