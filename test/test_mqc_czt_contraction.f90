module test_mqc_czt_contraction
   ...
   implicit none
   private
   public :: collect_mqc_czt_contraction_tests
   ...
   !! Water in Bohr, the same geometry the other cenzontle suites use.
...
contains
   ...
   subroutine collect_mqc_czt_contraction_tests(testsuite)
   ...
   end subroutine collect_mqc_czt_contraction_tests
...
end module test_mqc_czt_contraction

program tester
   use, intrinsic :: iso_fortran_env, only: error_unit
   use testdrive, only: run_testsuite, new_testsuite, testsuite_type
   use test_mqc_czt_contraction, only: collect_mqc_czt_contraction_tests
   implicit none
   integer :: stat, is
   ...
   stat = 0
   testsuites = [new_testsuite("mqc_czt_contraction", collect_mqc_czt_contraction_tests)]
