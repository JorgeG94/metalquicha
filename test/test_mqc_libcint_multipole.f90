...
module test_mqc_libcint_multipole
   ...
   public :: collect_mqc_libcint_multipole_tests

   real(dp), parameter :: ANG = 1.8897261254578281_dp

contains

   subroutine collect_mqc_libcint_multipole_tests(testsuite)
   ...
   end subroutine collect_mqc_libcint_multipole_tests
...
end module test_mqc_libcint_multipole

program tester
   use, intrinsic :: iso_fortran_env, only: error_unit
   use testdrive, only: run_testsuite, new_testsuite, testsuite_type
   use test_mqc_libcint_multipole, only: collect_mqc_libcint_multipole_tests
   implicit none
   integer :: stat, is
   ...
   stat = 0
   testsuites = [new_testsuite("mqc_libcint_multipole", collect_mqc_libcint_multipole_tests)]
