module test_mqc_libcint_guess
   ...
   implicit none
   private
   public :: collect_mqc_libcint_guess_tests
...
contains
   ...
   subroutine collect_mqc_libcint_guess_tests(testsuite)
   ...
   end subroutine collect_mqc_libcint_guess_tests
...
end module test_mqc_libcint_guess

program tester
   use, intrinsic :: iso_fortran_env, only: error_unit
   use testdrive, only: run_testsuite, new_testsuite, testsuite_type
   use test_mqc_libcint_guess, only: collect_mqc_libcint_guess_tests
   implicit none
   integer :: stat, is
   ...
   stat = 0
   testsuites = [new_testsuite("mqc_libcint_guess", collect_mqc_libcint_guess_tests)]
