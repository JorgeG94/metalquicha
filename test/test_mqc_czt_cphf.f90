...
module test_mqc_czt_cphf
   ...
   public :: collect_mqc_czt_cphf_tests
...
contains
   ...
   subroutine collect_mqc_czt_cphf_tests(testsuite)
...
program tester
   ...
   use test_mqc_czt_cphf, only: collect_mqc_czt_cphf_tests
   implicit none
   integer :: stat, is
   ...
   stat = 0
   testsuites = [new_testsuite("mqc_czt_cphf", collect_mqc_czt_cphf_tests)]
