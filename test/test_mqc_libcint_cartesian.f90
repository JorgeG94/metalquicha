module test_mqc_libcint_cartesian
   ...
   implicit none
   private
   public :: collect_mqc_libcint_cartesian_tests
...
contains
   ...
   subroutine collect_mqc_libcint_cartesian_tests(testsuite)
   ...
   end subroutine collect_mqc_libcint_cartesian_tests
...
end module test_mqc_libcint_cartesian

program tester_mqc_libcint_cartesian
   use, intrinsic :: iso_fortran_env, only: error_unit
   use testdrive, only: run_testsuite, new_testsuite, testsuite_type
   use test_mqc_libcint_cartesian, only: collect_mqc_libcint_cartesian_tests
   implicit none
   ...
   stat = 0
   testsuites = [ &
                new_testsuite("mqc_libcint_cartesian", collect_mqc_libcint_cartesian_tests) &
                ]
...
end program tester_mqc_libcint_cartesian
